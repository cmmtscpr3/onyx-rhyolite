...
PAYMENT_SYSTEM = (
    Group(
        ...
        note="As published, M1 is not the sum of the other two lines; BI's M1 definition includes components this table does not list.",
    ),
    Group(
        key="rtgs_value",
        heading="Currency and BI-RTGS",
...
DATASETS: tuple[Dataset, ...] = (
    ...
    Dataset(
        ...
        forced_status="stale",
        notes=(
            "OJK's public index has listed nothing after June 2025; the collector picks new releases up automatically when they appear.",
